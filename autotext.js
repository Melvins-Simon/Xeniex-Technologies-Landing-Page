...
// Autopying Js
const texts = ['for digital experience elevation','for Superior UX/UI Designs and deployments','for future invention through native ideas'];
const autotexts = new AutoTyping('#auto-text',texts,{
  typeSpeed: 50,
  deleteSpeed: 50,
